...
import { DIAGNOSTICS_CSS } from "../css";
...
describe("diagnostics stylesheet", () => {
  it("positions with logical properties so the panel mirrors under RTL", () => {
    ...
    expect(DIAGNOSTICS_CSS).not.toMatch(PHYSICAL_CSS_PATTERN);
  });
});
