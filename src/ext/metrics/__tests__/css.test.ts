...
describe("metrics stylesheet", () => {
  it("positions with logical properties so the chips, table and panel mirror under RTL", () => {
    ...
    expect(METRICS_CSS).not.toMatch(PHYSICAL_CSS_PATTERN);
  });
});
